...
jsPsych.plugins['xab-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function showSecondStimulus() {
      ...
      //EDIT:MK
      //delete randomization because I do this already
      ...
      // show the options
      // EDIT: MK
      // make AB float left and right

      display_element.innerHTML += '<div class="jspsych-xab-stimulus left" style="float:left">'+images[0]+'</div>';
      display_element.innerHTML += '<div class="jspsych-xab-stimulus right" style="float:right">'+images[1]+'</div>';
